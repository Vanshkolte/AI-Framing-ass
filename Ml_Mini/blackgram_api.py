...
CLASS_NAMES = ['Blackgram__anthracnose', 'Blackgram__healthy', 'Blackgram__leaf_crinckle', 'Blackgram__powdery_mildew', 'Blackgram__yellow_mosaic']
...
# uvicorn blackgram_api:app --reload